...
final class SettingsBindings {
    ...
    private let showDatePreference = BoolPreferenceStore(
        ...
        fallback: true)
    private let showListPreference = BoolPreferenceStore(
        key: BoolPreferenceKey.showList.rawValue,
        fallback: false)
    private let showRecurrencePreference = BoolPreferenceStore(
        key: BoolPreferenceKey.showRecurrence.rawValue,
        fallback: true)
    private let showAlarmsPreference = BoolPreferenceStore(
